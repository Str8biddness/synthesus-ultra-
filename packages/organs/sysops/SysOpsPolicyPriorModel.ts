...
export class SysOpsPolicyPriorModel {
  private params: SysOpsPolicyPriorModelParams;
  ...
  toJSON(): SysOpsPolicyPriorModelParams {
    return this.params;
  }

  static fromJSON(json: SysOpsPolicyPriorModelParams): SysOpsPolicyPriorModel {
    return new SysOpsPolicyPriorModel(json);
  }
  ...
  train(inputs: { stateFeatures: StateFeatures; actionFeaturesList: ActionFeatures[] }[], targets: number[][], options?: { epochs?: number; learningRate?: number }): void {
