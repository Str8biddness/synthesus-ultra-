// organs/sysops/SysOpsPolicyPriorOrgan.ts
...
export class SysOpsPolicyPriorOrgan implements Organ<{ stateFeatures: StateFeatures; actionFeaturesList: ActionFeatures[] }, { scores: number[] }> {
  ...
  constructor(params?: SysOpsPolicyPriorModelParams) {
    this.model = params ? SysOpsPolicyPriorModel.fromJSON(params) : undefined;
  }
  ...
  static loadFromParams(params: SysOpsPolicyPriorModelParams): SysOpsPolicyPriorOrgan {
    return new SysOpsPolicyPriorOrgan(params);
  }
